...
const ScanArea: React.FC<ScanAreaProps> = ({ onSave }) => {
  ...
  const [linkType, setLinkType] = useState<'linkedin' | 'bitly' | 'netflix' |'instagram' | 'tiktok' | 'website' | 'facebook' | 'wikipedia' | 'xyz' | 'amazon' | 'unknown'>('unknown'); // Type of link detected
