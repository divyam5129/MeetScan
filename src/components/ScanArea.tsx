...
const ScanArea: React.FC<ScanAreaProps> = ({ onSave }) => {
  ...
  const [linkType, setLinkType] = useState<'linkedin' | 'bitly' | 'instagram' | 'website' | 'facebook' | 'unknown'>('unknown'); // Type of link detected
  ...
  const renderLinkIcon = () => {
    switch (linkType) {
     ...
     case 'facebook':
        return <img src={linkedinIcon} alt="Facebook" className="h-6 w-6" />;
      default:
        return <p>URL</p>;
    }
  };
